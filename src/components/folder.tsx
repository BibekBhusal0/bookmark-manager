  ...
  return (
    <div className={cn(commonCls, "group relative")}>
      <svg
        ...
        className={cn(
          commonCls,
          "group size-full relative stroke-primary-300"
        )}>
        <path
          className={cn(commonCls, "origin-bottom-right fill-success-400", {
        ...
        />
        <rect
          className={cn(commonCls, "origin-bottom-left fill-success-500", {
